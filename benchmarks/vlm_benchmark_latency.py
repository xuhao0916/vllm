...
def main(args: argparse.Namespace):
    ...
    if(args.input_len > image_feature_size):
        prompt_token_ids = [hf_config.image_token_index] + [random.randint(10, 10000) for _ in range(args.input_len - 1)]
        ...
        prompt_token_ids = [random.randint(10, 10000) for _ in range(args.input_len)]

    tokens_prompt = TokensPrompt(prompt_token_ids=prompt_token_ids, multi_modal_data=mm_data)
    dummy_inputs = [tokens_prompt] * args.batch_size 
